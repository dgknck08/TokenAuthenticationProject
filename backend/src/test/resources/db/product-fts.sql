-- Üretimdeki V8__add_product_search_fts.sql'in aynısı. Testlerde şemayı
-- Hibernate ürettiği için search_vector kolonu oluşmuyor; bu betik onu ekler
-- ki gerçek arama sorgusu (LIKE fallback yerine) çalışsın. Tümü idempotent.
